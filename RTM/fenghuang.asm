...
i db 25h,73h,0
n db 1319 DUP(0)
a db '; ////-;-; Feng Huang-; by alCoPaUL [GIMO][As][aBrA][NPA][b8][BCVG][rRlf]-; 2/27/2023 Revised: 6/01/2024 @ NYC-; ml.exe fenghuang.asm /link /subsyst'
db 'em:console /defaultlib:msvcrt.lib kernel32.lib legacy_stdio_definitions.lib legacy_stdio_wide_specifiers.lib ucrt.lib /merge:.CRT=.rdata /entry:start-'
